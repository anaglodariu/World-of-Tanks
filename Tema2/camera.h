...
namespace implementedCamera
{
    ...
    public:
        ...
        // update camera
        void SetDependingOnTank(const glm::vec3& target) {
            glm::vec3 newPosition = target - distanceToTarget * forward;
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            //glm::vec3 distance = glm::normalize(glm::vec3(forward.x, 0, forward.z)) * distanceToTarget;
            //position += distance;
        ...
        void RotateThirdPerson_OY(float angle)
        {
            // TODO(student): Rotate the camera in third-person mode around
            // the OY axis.
            //glm::vec3 distance = glm::normalize(glm::vec3(right.x, 0, right.z)) * distanceToTarget;
            //position += distance;
            TranslateForward(distanceToTarget);
